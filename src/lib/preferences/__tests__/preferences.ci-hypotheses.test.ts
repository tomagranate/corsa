...
const runHypotheses = process.env.CORSA_RUN_CI_HYPOTHESES === "1";
const maybeDescribe = runHypotheses ? describe : describe.skip;
...
maybeDescribe(
	"preferences CI hypotheses (enable with CORSA_RUN_CI_HYPOTHESES=1)",
	() => {
